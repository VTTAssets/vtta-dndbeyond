const DICTIONARY = {
  ...
  character: {
    ...
    skills: [
      { name: "acr", label: "Acrobatics", ability: "dex", subType: "acrobatics" },
      { name: "ani", label: "Animal Handling", ability: "wis", subType: "animal-handling" },
      { name: "arc", label: "Arcana", ability: "int", subType: "arcana" },
      { name: "ath", label: "Athletics", ability: "str", subType: "athletics" },
      { name: "dec", label: "Deception", ability: "cha", subType: "deception" },
      { name: "his", label: "History", ability: "int", subType: "history" },
      { name: "ins", label: "Insight", ability: "wis", subType: "insight" },
      { name: "itm", label: "Intimidation", ability: "cha", subType: "intimidation" },
      { name: "inv", label: "Investigation", ability: "int", subType: "investigation" },
      { name: "med", label: "Medicine", ability: "wis", subType: "medicine" },
      { name: "nat", label: "Nature", ability: "int", subType: "nature" },
      { name: "prc", label: "Perception", ability: "wis", subType: "perception" },
      { name: "prf", label: "Performance", ability: "cha", subType: "performance" },
      { name: "per", label: "Persuasion", ability: "cha", subType: "persuasion" },
      { name: "rel", label: "Religion", ability: "int", subType: "religion" },
      { name: "slt", label: "Sleight of Hand", ability: "dex", subType: "sleight-of-hand" },
      { name: "ste", label: "Stealth", ability: "dex", subType: "stealth" },
      { name: "sur", label: "Survival", ability: "wis", subType: "survival" },
    ],
    alignments: [
