...
/** resolves once a dialog with a certain ID is rendered. The dialog html is then returned */
// const waitForDialog = (id) => {
//   return new Promise((resolve, reject) => {
//     console.log("Waiting for dialog " + id);
//     const hook = (dialog, html, options) => {
